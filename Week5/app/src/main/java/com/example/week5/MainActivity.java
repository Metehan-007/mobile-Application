...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int i = 0 ; i < 3 ; i++) {
            ...
            for(int j = 0 ; j < 3; j++) {
                ...
                button.setOnClickListener(new CallListeneer(i,j));
            }
        }
    ...
    class CallListeneer implements View.OnClickListener{
        int row, col;

        public CallListeneer(int row, int col) {
            this.row = row;
            this.col = col;
        }
        ...
        public void onClick(View v){
            if(isValidMove(row,col)){
                Toast.makeText(MainActivity.this,"Call Already occupied",Toast.LENGTH_LONG).show();
                return;
            }
            if(player1Turn) {
            ...
            if(gameEnded(row,col) == -1) {
                ...
                Toast.makeText(MainActivity.this,
                        "It is a Draw", Toast.LENGTH_LONG).show();
